  ...
  return (
    ...
    >
      ...
      <Image
        ...
        fill
        className="absolute inset-0 object-cover opacity-10 sm:opacity-20 z-0 pointer-events-none"
      />
      ...
      >
        <Image
          ...
          width={450}
          height={350}
          className="object-contain w-[80%] sm:w-[70%] md:w-[90%] lg:w-[80%] max-w-[450px] h-auto"
        />
      </motion.div>
...
export default function ServicesSection() {
  return (
    <section className="relative z-10 py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 lg:px-24 bg-black text-white">
      <div className="max-w-7xl mx-auto space-y-24 sm:space-y-28 md:space-y-32 relative z-10">
        {/* Animated Heading */}
        <motion.h1
          className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center mb-12 sm:mb-16 md:mb-20 text-white"
