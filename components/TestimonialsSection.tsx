    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-black text-white py-24 overflow-hidden px-6 md:px-10">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold mb-4">
          What Our Clients <span className="text-orange-400 italic font-medium">Are Saying</span>
        </h2>
      </motion.div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-24 w-full max-w-7xl">
        ...
        <div className="relative w-[400px] h-[400px] flex-shrink-0">
                ...
                >
                  <motion.button
                    ...
                    className={clsx(
                      ...
                      selected === index
                        ? 'border-orange-400 shadow-lg shadow-orange-500/40 scale-110'
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
            <div className="w-24 h-24 rounded-full bg-black shadow-xl flex items-center justify-center overflow-hidden border-4 border-black">
              <img
                src="/images/3.png" // ✅ make sure this is in public/images/3.png
                alt="Company Logo"
        ...
        <motion.div
          ...
          className="w-full max-w-md bg-zinc-900 border border-gray-700 rounded-2xl p-10 shadow-2xl"
        >
