...
const clients = [
  {
    ...
    message:
      'The talented team behind our content development creates insightful and engaging pieces that truly resonate with your target audience.',
  },
  {
    id: 2,
    name: 'John Doe',
    ...
    message:
      'Working with this team was a game-changer. Their dedication and creativity were beyond expectations.',
  },
  {
    id: 3,
    name: 'Sarah Johnson',
    ...
    image: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=150&h=150&fit=crop&crop=face',
    message:
      'Their attention to detail and commitment to delivering quality work is unmatched.',
  },
  {
    id: 4,
    name: 'Mike Chen',
  ...
  },
  {
    ...
    message:
      'Exceptional technical expertise and seamless collaboration throughout the project.',
  },
];
...
const TestimonialSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-black via-zinc-900 to-black text-white py-24 overflow-hidden px-6 md:px-10">
      {/* Heading */}
      <motion.div
      ...
      >
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4 tracking-tight">
          What Our Clients{' '}
          <span className="text-violet-400 italic font-semibold">Are Saying</span>
        </h2>
        <p className="text-gray-400 max-w-xl mx-auto text-lg">
          Stories of trust and transformation from people who partnered with us.
        </p>
      </motion.div>
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-24 w-full max-w-7xl">
        ...
        <motion.div
          ...
          className="w-full max-w-md bg-zinc-900/90 backdrop-blur-sm border border-gray-800 rounded-3xl p-10 shadow-[0_0_40px_rgba(139,92,246,0.2)] hover:shadow-[0_0_60px_rgba(139,92,246,0.35)] transition-shadow"
        >
          <div className="flex justify-center mb-6">
            {[...Array(5)].map((_, i) => (
              <Star key={i} size={20} className="text-yellow-400 fill-yellow-400 mx-0.5 drop-shadow" />
            ))}
          </div>
          ...
          <div className="flex items-center justify-center gap-4">
            <div className="w-14 h-14 rounded-full overflow-hidden ring-2 ring-violet-400/60 shadow-md shadow-violet-500/30">
              <img
        ...
        <div className="relative w-[400px] h-[400px] flex-shrink-0">
              ...
              return (
                ...
                >
                  <motion.button
                    ...
                    transition={{ duration: 20, repeat: Infinity, ease: 'linear' }}
                    className={clsx(
                      'transform transition-all duration-300 border-2 rounded-full p-1 hover:scale-110 shadow-md',
                      selected === index
                        ? 'border-violet-400 shadow-lg shadow-violet-500/40 scale-115'
                        : 'border-gray-600 hover:border-violet-300/60'
                    )}
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
            <div className="w-28 h-28 rounded-full bg-zinc-950 shadow-2xl flex items-center justify-center overflow-hidden border-4 border-zinc-900 ring-4 ring-violet-500/30">
              <img
                src="/images/3.png"
                alt="Company Logo"
